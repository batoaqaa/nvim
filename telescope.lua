...
return {
  {
    ...
    -- Do not use tags/branches like '0.1.x' for Neovim 0.11+ for now
    ...
    config = function()
      ...
      require('telescope').setup({
        ...
        --
        defaults = {
          file_ignore_patterns = { '%.pio/', 'node_modules/', '%.git/', '%.cache', 'node_modules' },
          mappings = {
      ...
      vim.keymap.set('n', '<leader>fs', function()
        builtin.lsp_dynamic_workspace_symbols({
          query = ' ',
          symbols = { 'Function', 'function', 'method', 'class', 'module' },
        })
      end, { desc = 'Project Functions' })

      vim.keymap.set('n', '<leader>ds', builtin.lsp_document_symbols, { desc = 'File Functions' })
